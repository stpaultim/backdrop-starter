...
<div class="layout--moscone-flipped <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  ...
  <?php if ($content['header']): ?>
    <header class="l-header with_header_bg" role="banner" aria-label="<?php print t('Site header'); ?>">
  ...
  <div class="l-wrapper">
    <?php if (!empty($content['top'])): ?>
      ...
      <div class="header_bg_angle">
        <svg id="header_bg_triangle" xmlns="http://www.w3.org/2000/svg" width="100%" height="50" viewBox="0 0 100 100" preserveAspectRatio="none">
          <path d="M0 0 L0 100 L100 100 L100 0 L50 100 Z" fill="#ffffff"></path>
        </svg>
      </div>
    <?php endif; ?>
