 ...
 * This template is exactly the same as Boxton, but an .info file is required in
 * the project root for listing on BackdropCMS.org.
 *
 * Variables:
 ...
 */
?>
<div class="hero-layouts layout--hero <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
